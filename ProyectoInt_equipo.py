...
class Usuario:
    ...
    def imprimir_pase(self, aeropuerto, vuelo):
        ...
        for v in self.__vuelos:
            print(v)
            print(f'Asiento: {self.asientos()}           Puerta: {aeropuerto.puerta}           Terminal: {aeropuerto.term(v1)}')
...
if __name__ == '__main__':
    u1 = Usuario('José Carlos', 'Morelos', 'AeroMéxico')
    u2 = Usuario('Eva Vargas', 'Jalisco', 'Volaris')
    v1 = Vuelos('Morelos', 'AeroMéxico', '7:50')
    v2 = Vuelos('Jalisco', 'Volaris', '6:25')
